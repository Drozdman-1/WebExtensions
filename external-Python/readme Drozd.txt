...
External program for ther DrozdTools WebExtension (Firefox).
Python script compiled. Executable.
https://github.com/Drozdman-1/WebExtensions/releases/download/WebExtension/DrozdTools_app_Python.zip
https://github.com/Drozdman-1/WebExtensions/releases/download/WebExtension_Drozd2/DrozdTools_app_compiled.zip




This addons may be used for:
  ● archiving quotes from webpages with date and url in text format by appending an archive file (or Twitter posts)
  ● saving whole articles or their parts as html files with dates and urls
  (may be of use for sports journalists, etc.)
  ● User JS & CSS styles
  ● It allows to remember last post on Twitter profile page,


● Allows selected text of a webpage
 - to be saved as an html file including date, time & url.
 - appended to an archive file  including date & url.
May be used


● archiving quotes from webpages with date & url (like Twitter posts)
● saving articles as html files (date & url)
  (may be of use for sports journalists, etc.)
● User JS & CSS styles
● It allows to remember last post on Twitter profile page
...
Requires external program ("Native Messaging"), files included within the addon as text files.
Link https://github.com/Drozdman-1/WebExtensions/blob/main/README.md


https://addons.mozilla.org/addon/drozd-tools/
